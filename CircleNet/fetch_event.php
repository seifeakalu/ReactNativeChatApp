...
$sql="SELECT * FROM calendar ORDER BY id DESC   LIMIT $load_more_id, 2";
...
$userArray[]=array( 'id' => $id, 'on_date' => $date, 'discription' => $discription, 'event' => $event, 'posted_on' => $posted_on, 'created_by' => 'seife akalu',  'load_more' => $load_more_id);
